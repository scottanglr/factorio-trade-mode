local constants = {
  ...
  gui = {
    ...
    mod_button = "trade_mode_mod_button",
    ...
    buy_order_close = "trade_mode_buy_order_close",
    ...
    admin_scroll = "trade_mode_admin_scroll",
    window_balance = "trade_mode_window_balance",
    selected_contract = "trade_mode_selected_contract",
    inserter_panel = "trade_mode_inserter_panel",
    inserter_min_price = "trade_mode_inserter_min_price",
    inserter_min_price_save = "trade_mode_inserter_min_price_save",
    inserter_feedback = "trade_mode_inserter_feedback",
  },
