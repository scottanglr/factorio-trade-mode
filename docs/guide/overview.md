...
Factorio Trade Mode adds a lightweight player economy on top of normal Factorio production. Instead of only moving items between your own belts, chests, and trains, players can publish buy orders, fulfill each other's requests, create contracts, and earn gold from both trade and system-wide UBI.
...
4. The mod transfers gold from the buyer to the supplier automatically.
...
| Inserter stats | Relative panel when you select an inserter | Shows lifetime payout and recent delivery information |
...
- Trade settlements and contract payouts both use this same balance.
